...
/**
 * Reads all records from the levels.txt file.
 *
 * @param[in]     fp         Opened file connection to read from.
 * @param[out]    records    A non-allocated array of of level_t records.
 *
 * @returns       -1 on failure/error, number of records on success.
 *
 * @ingroup       Core__EntityFileReading
...
/**
 * Reads all records from the pathways.txt file.
 *
 * @param[in]     fp         Opened file connection to read from.
 * @param[out]    records    A non-allocated array of of pathway_t records.
 *
 * @returns       -1 on failure/error, number of records on success.
 *
 * @ingroup       Core__EntityFileReading
